...
contract Desafio_1 {
    ...
    function guardarActivoSimple(address user , uint256 cantidad ) public /**...address, uint256 */ {
        require(user != address(0),"El address no puede ser 0x00");
        activosSimple[user] = cantidad;
    }
